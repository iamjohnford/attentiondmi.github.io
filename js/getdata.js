$(document).ready(function() {
    ...
    $.getJSON('data/iyagi.json', function(data) {
        ...
        $(data).each(function() {
          ...
          output = output +  "<li class='sidebar_item'" + titleProp + media_url_prop + posterProp + contentProp + languageProp + tagsProp  + "><a href='#' title='" + title + "'><i class='fa fa-file-text'></i> <span>"+ title + "</span></a></li>";
        });
